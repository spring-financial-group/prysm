...
func (x *ExecutionPayloadEnvelope) GetSlot() github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
	return github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot(0)
...
type BlindPayloadEnvelope struct {
	...
	BlobGasUsed        uint64                                                                      `protobuf:"varint,14,opt,name=blob_gas_used,json=blobGasUsed,proto3" json:"blob_gas_used,omitempty"`
	ExcessBlobGas      uint64                                                                      `protobuf:"varint,15,opt,name=excess_blob_gas,json=excessBlobGas,proto3" json:"excess_blob_gas,omitempty"`
	BuilderIndex       github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex `protobuf:"varint,16,opt,name=builder_index,json=builderIndex,proto3" json:"builder_index,omitempty" cast-type:"github.com/prysmaticlabs/prysm/v5/consensus-types/primitives.ValidatorIndex"`
	BeaconBlockRoot    []byte                                                                      `protobuf:"bytes,17,opt,name=beacon_block_root,json=beaconBlockRoot,proto3" json:"beacon_block_root,omitempty" ssz-size:"32"`
	Slot               github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot           `protobuf:"varint,18,opt,name=slot,proto3" json:"slot,omitempty" cast-type:"github.com/prysmaticlabs/prysm/v5/consensus-types/primitives.Slot"`
	BlobKzgCommitments [][]byte                                                                    `protobuf:"bytes,19,rep,name=blob_kzg_commitments,json=blobKzgCommitments,proto3" json:"blob_kzg_commitments,omitempty" ssz-max:"4096" ssz-size:"?,48"`
	BeaconStateRoot    []byte                                                                      `protobuf:"bytes,20,opt,name=beacon_state_root,json=beaconStateRoot,proto3" json:"beacon_state_root,omitempty" ssz-size:"32"`
}
...
func (x *BlindPayloadEnvelope) GetParentHash() []byte {
	if x != nil {
		return x.ParentHash
	}
	return nil
...
func (x *BlindPayloadEnvelope) GetFeeRecipient() []byte {
	if x != nil {
...
func (x *BlindPayloadEnvelope) GetReceiptsRoot() []byte {
	if x != nil {
...
func (x *BlindPayloadEnvelope) GetLogsBloom() []byte {
	if x != nil {
		return x.LogsBloom
	}
	return nil
...
func (x *BlindPayloadEnvelope) GetPrevRandao() []byte {
	if x != nil {
		return x.PrevRandao
	}
	return nil
...
func (x *BlindPayloadEnvelope) GetBlockNumber() uint64 {
	if x != nil {
...
func (x *BlindPayloadEnvelope) GetGasLimit() uint64 {
	if x != nil {
		return x.GasLimit
	}
	return 0
...
func (x *BlindPayloadEnvelope) GetGasUsed() uint64 {
	if x != nil {
		return x.GasUsed
	}
	return 0
...
func (x *BlindPayloadEnvelope) GetTimestamp() uint64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
func (x *BlindPayloadEnvelope) GetExtraData() []byte {
	if x != nil {
		return x.ExtraData
	}
	return nil
...
func (x *BlindPayloadEnvelope) GetBaseFeePerGas() []byte {
	if x != nil {
...
func (x *BlindPayloadEnvelope) GetBlockHash() []byte {
	if x != nil {
		return x.BlockHash
	}
	return nil
...
func (x *BlindPayloadEnvelope) GetBlobGasUsed() uint64 {
	if x != nil {
...
func (x *BlindPayloadEnvelope) GetExcessBlobGas() uint64 {
	if x != nil {
...
func (x *BlindPayloadEnvelope) GetSlot() github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
	return github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot(0)
...
func (x *BlindPayloadEnvelope) GetBeaconStateRoot() []byte {
	if x != nil {
...
var file_proto_engine_v1_epbs_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x6f, 0x6f, 0x74, 0x12, 0x59, 0x0a, 0x04,
	...
	0x74, 0x52, 0x04, 0x73, 0x6c, 0x6f, 0x74, 0x12, 0x42, 0x0a, 0x14, 0x62, 0x6c, 0x6f, 0x62, 0x5f,
...
var file_proto_engine_v1_epbs_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_proto_engine_v1_epbs_proto_goTypes = []interface{}{
	...
	(*SignedBlindPayloadEnvelope)(nil),     // 4: ethereum.engine.v1.SignedBlindPayloadEnvelope
	(*BlindPayloadEnvelope)(nil),           // 5: ethereum.engine.v1.BlindPayloadEnvelope
	(*ExecutionPayloadDeneb)(nil),          // 6: ethereum.engine.v1.ExecutionPayloadDeneb
	(*ExecutionRequests)(nil),              // 7: ethereum.engine.v1.ExecutionRequests
}
var file_proto_engine_v1_epbs_proto_depIdxs = []int32{
	...
	6, // 1: ethereum.engine.v1.ExecutionPayloadEnvelope.payload:type_name -> ethereum.engine.v1.ExecutionPayloadDeneb
	7, // 2: ethereum.engine.v1.ExecutionPayloadEnvelope.execution_requests:type_name -> ethereum.engine.v1.ExecutionRequests
	2, // 3: ethereum.engine.v1.SignedExecutionPayloadEnvelope.message:type_name -> ethereum.engine.v1.ExecutionPayloadEnvelope
	5, // 4: ethereum.engine.v1.SignedBlindPayloadEnvelope.message:type_name -> ethereum.engine.v1.BlindPayloadEnvelope
